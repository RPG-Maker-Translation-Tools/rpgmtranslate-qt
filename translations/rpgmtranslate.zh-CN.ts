...
%1</translation>
    ...
    <message>
        ...
        <translation>正在将游戲数据复制到 .rpgmtranslate/baseline-data 作为基线数据。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>无法从 Game.ini/RPG_RT.ini 文件中提取标题：%1</translation>
    </message>
    <message>
        <location filename="../src/ReadMenu/ReadMenu.cpp" line="132"/>
        <source>Title is empty in %1 file.</source>
        <translation>标题在 %1 文件中为空。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>强制将文本解码为指定的代码页，而非自动猜测。适用于 RPG Maker 2000/2003、XP 和 VX——这些旧版引擎没有自带编码，默认使用系统代码页（VX Ace、MV 和 MZ 除外）。留空则自动猜测。如果下方游戲标题含有非 ASCII 字符，可帮助确定正确的编码。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>从 ini 文件读取标题：若游戲为 RPG Maker XP/VX/VX Ace 或 RM2K/2003，系统文件中可能不含游戲标题。使用此选项从 Game.ini（XP/VX/VX Ace）或 RPG_RT.ini（RM2K/2003）中读取，取游戲目录中实际存在的那个文件。你需要在上方“文本编码”字段中选对编码。若标题显示为乱码，即表示编码有误。若未勾选此选项，则会尝试从系统文件中读取标题（如有）。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>将翻译内容写回时强制使用指定代码页编码，而非妥始 UTF-8。除非确认目标游戲引擎不支持 Unicode 渲染，且翻译脚本内容适合所选代码页，否则留空。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>热键 %1 被同时分配给“%2”和“%3”。请指定一个不同的热键。</translation>
    </message>
    <message>
